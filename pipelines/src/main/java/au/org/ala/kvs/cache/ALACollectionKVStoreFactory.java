...
public class ALACollectionKVStoreFactory {
  ...
  private static KeyValueStore<ALACollectionLookup, ALACollectionMatch> cache2kBackedKVStore(
      ALACollectoryService service, Command closeHandler, ALAKvConfig config) {
    ...
    return KeyValueCache.cache(kvs, config.getCollectionCacheMaxSize(), ALACollectionLookup.class,
