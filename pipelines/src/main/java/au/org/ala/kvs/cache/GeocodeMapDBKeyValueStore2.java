...
public class GeocodeMapDBKeyValueStore2 implements KeyValueStore<LatLng, GeocodeResponse> {

  private final GeocodeServiceSyncClient service;
  private final DB db;
  private final HTreeMap<LatLng, GeocodeResponse> cache;

  private GeocodeMapDBKeyValueStore2(ClientConfiguration config) {
  ...
  public static GeocodeMapDBKeyValueStore2 create(ClientConfiguration config) {
    return new GeocodeMapDBKeyValueStore2(config);
  }
