...
public class ALAKvConfigFactory {
  ...
  public static ALAKvConfig create(@NonNull Properties props) {
    ...
    Boolean geocodeCachePersistEnabled = Boolean
        .parseBoolean(props.getProperty(GEOCODE_CACHE_PERSIST_ENABLED, "false"));
    Boolean taxonomyCachePersistEnabled = Boolean
        .parseBoolean(props.getProperty(TAXONOMY_CACHE_PERSIST_ENABLED, "false"));
    Boolean collectionCachePersistEnabled = Boolean
        .parseBoolean(props.getProperty(COLLECTION_CACHE_PERSIST_ENABLED, "false"));
    Boolean metadataCachePersistEnabled = Boolean
        .parseBoolean(props.getProperty(METADATA_CACHE_PERSIST_ENABLED, "false"));

    long geocodeCacheMaxSize = Long.parseLong(props.getProperty(GEOCODE_CACHE_MAX_SIZE, "100000"));
    long taxonomyCacheMaxSize = Long
        .parseLong(props.getProperty(TAXONOMY_CACHE_MAX_SIZE, "100000"));
    long collectionCacheMaxSize = Long
        .parseLong(props.getProperty(COLLECTION_CACHE_MAX_SIZE, "100000"));
    long metadataCacheMaxSize = Long
        .parseLong(props.getProperty(METADATA_CACHE_MAX_SIZE, "100000"));
