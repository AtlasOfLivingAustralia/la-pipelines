...
public class ExportAllLatLongCSVPipeline {
  ...
  public static void main(String[] args) throws Exception {
    AllDatasetsPipelinesOptions options = PipelinesOptionsFactory
        .create(AllDatasetsPipelinesOptions.class, args);
    run(options);
  }
  ...
  public static void run(AllDatasetsPipelinesOptions options) throws Exception {
    ...
    UnaryOperator<String> pathFn = t -> "/data/pipelines-data/**/1/interpreted/" + t
        + "/interpret-*" + AVRO_EXTENSION;
