 ...
 * Rounded decimal of predefined state centres based on precision of the given coordinates
 *
 * @author Bai187
 */
@Slf4j
public class CentrePoints {
            ...
            try {
                ...
                Files.lines(new File(filePath).getAbsoluteFile().toPath())
                        ...
                        .forEach(l -> {
                            ...
                            BBox bbox = new BBox(Double.parseDouble(ss[3]),Double.parseDouble(ss[4]),Double.parseDouble(ss[5]),Double.parseDouble(ss[6]));
    ...
    /**
     * Precision of coordinate is determined by the given lat and lng
     * for exmaple, given lat 14.39, will only compare to the second decimal
     *
     * @param state
    ...
    public static void main(String[] args){
        CentrePoints cps = CentrePoints.getInstance("pipelines/src/main/resources/stateProvinceCentrePoints.txt");
